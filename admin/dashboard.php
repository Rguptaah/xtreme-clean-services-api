...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-12">
                    <h3 class="page-title">Welcome <?= ucfirst(get_all('user', '*', array('id' => $user_id))['data'][0]['first_name']); ?>! </h3>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="dash-widget-header">
                            ...
                            <div class="dash-widget-info">
                                <h3><?= get_all('user', '*', array('role' => 'U'))['count']; ?></h3>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="dash-widget-header">
                            ...
                            <div class="dash-widget-info">
                                <h3><?= get_all('user', '*', array('role' => 'S'))['count']; ?></h3>
                        ...
                        <div class="table-responsive">
                            <table class="table table-center">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-nowrap">
                                            <img class="avatar-xs rounded-circle" src="assets/img/customer/user-06.jpg" alt="User Image"> Stephen Wilson
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-nowrap">
                                            <img class="avatar-xs rounded-circle" src="assets/img/customer/user-07.jpg" alt="User Image"> Ryan Rodriguez
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text-nowrap">
                                            <img class="avatar-xs rounded-circle" src="assets/img/customer/user-09.jpg" alt="User Image"> Roland Storey
                                        </td>
