...
if ($result['count'] == 1) {
    ...
    echo json_encode(['status' => 'success', 'data' => $result['data'][0], 'result' => 'found', 'token' => $jwt]);
} else {
    echo json_encode(array('status' => 'error', 'result' => "Invalid or Missing email and password"));
}
?>